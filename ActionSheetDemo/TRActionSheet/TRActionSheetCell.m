...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        self.otherButtonLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 290 * self.frame.size.width / 320, 44)];
        ...
        self.seperateline = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 290 * self.frame.size.width / 320, 1)];
